            ...
            <div className="cntcLeft">
                ...
                <div className="addrsLink">
                    <div className="address">
                        <p><FontAwesomeIcon icon={faYahoo} style={{width:'1.3rem'}}/><Link href={'mailto:abdullah.shayed@protonmail.com'} style={{color:'white',textDecoration:'none'}}>abdullah.shayed@protonmail.com</Link> </p>
